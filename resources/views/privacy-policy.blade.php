            ...
            <div class="content">
                ...
                <ol style="margin: 0; padding: 0; list-style: none;">
                    ...
                    <li>
                        ...
                        <p>If you are not happy with our privacy policy or if you have any complaint then you should tell us by emailing <a href="mailto:{{ env('MAIL_FROM_ADDRESS') }}">{{ env('MAIL_FROM_ADDRESS') }}</a>. If a dispute is not settled then we hope you will agree to attempt to resolve it by engaging in good faith with us in a process of mediation or arbitration. If you are in any way dissatisfied about how we process your personal information, you have a right to lodge a complaint with the Information Commissioner's Office (ICO). This can be done at <a href="https://ico.org.uk/make-a-complaint">https://ico.org.uk/make-a-complaint</a>. We would, however, appreciate the opportunity to talk to you about your concern and rectify it before you approach the ICO.</p>
                    </li>
                    <li>
                ...
                <p>Copyright © 2022 {{ env('APP_NAME_REF') }} are a UK based Company, Registration number: 14267665. Registered Office: {{ env('APP_NAME_REF') }}, {{ env('ADDRESS') }}</p>
            </div>
        </div>
    </div>
</section>
